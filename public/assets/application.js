...
(function() {
  ...
  jQuery(function() {
    return $('a').pjax('[data-pjax-container]');
  });
...
(function() {
  ...
  $(function() {
    return $("#store_update_submit").click(function(event) {
      if ($('#store_domain').val() !== $('#hidden_domain').html()) {
        if (!confirm("You are about to change your store URL. This will break links. Would you like to proceed?")) {
