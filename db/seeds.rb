...
store = Store.create(name: 'Test Store', domain: 'test-store', creating_user_id: 1, description: 'This is a moderately description for a store that I love. It is the best place in the world.')
